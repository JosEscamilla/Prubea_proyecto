...
class _FirstScreenState extends State<FirstScreen> {
              ...
              TableCalendar(
                ...
                calendarStyle: CalendarStyle(
                  ...
                  selectedDecoration: BoxDecoration(
                      color: blueCharcoal, shape: BoxShape.circle),
                  todayDecoration: BoxDecoration(
                      color: blueSaphire,
                      border: Border.all(
                        color: Color.fromARGB(250, 5, 6, 0),
                        width: 3, //codigo agregado
                      ),
                    ...
                    return Dismissible(
                      ...
                      child: Container(
                        ...
                        child: Column(children: <Widget>[
                          ...
                          SizedBox(height: 20),
                          ElevatedButton(
                              onPressed: () => print(notas[index].llave),
                              child: Text('$index'))
                        ]),
                      ),
  ...
  Future guardar_datos(
      String titulo, String contenido, Color color, int inde) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
